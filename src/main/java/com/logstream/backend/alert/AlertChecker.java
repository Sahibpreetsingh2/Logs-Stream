...
public class AlertChecker {
	    ...
	    private void triggerAlert(long matchCount) {
	        ...
	        // TODO: wire this into a NotificationService (webhook/email) once ready
	    }

	    // Temporary mock data — replace with real Lucene search results once Member 2's part is ready
